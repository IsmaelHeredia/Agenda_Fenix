...
$(document).ready(function () {
    ...
    $('#dpFecha_inicio').datetimepicker({
        ...
        $('#proyectoForm').bootstrapValidator('revalidateField', 'fecha_inicio');
    });
    ...
    $('#dpFecha_terminado').datetimepicker({
        ...
        $('#proyectoForm').bootstrapValidator('revalidateField', 'fecha_terminado');
    });
    ...
    $('#dpFecha').datetimepicker({
        ...
        $('#actividadForm').bootstrapValidator('revalidateField', 'fecha');
    });
